...
//
//    @Test
//    void getFreeVisitsByDoctorId_VisitFound_PageReturned() {
//        // given
//        Long doctorId = 1L;
//        Doctor doctor = createDoctor();
//        Visit visit = createVisit();
...
//        // when
//        PageDto<VisitDto> result = visitService.getVisitsByDoctorId(doctorId, pageable);
//        // then
//        Assertions.assertAll(
//                () -> assertEquals(page.getTotalPages(), result.totalPages()),
//                () -> assertEquals(page.getTotalElements(), result.totalElements()),
...
//
//    @Test
//    void getVisitsByDateAndDoctorSpecialization_VisitFound_PageReturned() {
//        // given
...
//        Pageable pageable = PageRequest.of(0, 1);
//        Page<Visit> page = new PageImpl<>(visits, pageable, 1);
//        when(visitRepository.findByStartDateGreaterThanEqualAndStartDateLessThanAndDoctorSpecializationAndPatientIsNull(
//                date.atStartOfDay(), date.plusDays(1).atStartOfDay(), Specialization.DERMATOLOGIST, pageable)).thenReturn(page);
//        // when
//        PageDto<VisitDto> result = visitService.getVisitsByDateAndDoctorSpecialization(date, doctorSpecialization, pageable);
//        // then
//        Assertions.assertAll(
//                () -> assertEquals(page.getTotalPages(), result.totalPages()),
//                () -> assertEquals(page.getTotalElements(), result.totalElements()),
//                () -> assertFalse(result.content().isEmpty())
//        );
//        verify(visitRepository, times(1)).findByStartDateGreaterThanEqualAndStartDateLessThanAndDoctorSpecializationAndPatientIsNull(
//                date.atStartOfDay(), date.plusDays(1).atStartOfDay(), Specialization.DERMATOLOGIST, pageable);
//        verifyNoMoreInteractions(visitRepository);
//        verifyNoInteractions(doctorRepository, patientRepository);
//    }
//
