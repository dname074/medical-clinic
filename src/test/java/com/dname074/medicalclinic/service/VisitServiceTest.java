...
//
//    @Test
//    void getVisitsByDoctorId_FreeVisitFound_PageReturned() {
//        // given
//        Long doctorId = 1L;
...
//        Pageable pageable = PageRequest.of(0, 1);
//        Page<Visit> page = new PageImpl<>(visits, pageable, 1);
//        when(visitRepository.findByDoctorIdAndPatientIsNull(doctorId, pageable)).thenReturn(page);
//        // when
//        PageDto<VisitDto> result = visitService.getVisitsByDoctorId(doctorId, visitAvailability, pageable);
//        // then
//        Assertions.assertAll(
//                () -> assertEquals(page.getTotalPages(), result.totalPages()),
//                () -> assertEquals(page.getTotalElements(), result.totalElements()),
//                () -> assertFalse(result.content().isEmpty())
//        );
//        verify(visitRepository, times(1)).findByDoctorIdAndPatientIsNull(1L, pageable);
//        verifyNoMoreInteractions(visitRepository);
//        verifyNoInteractions(doctorRepository, patientRepository);
//    }
//
//    @Test
//    void getVisitsByDoctorId_FreeVisitNotFound_EmptyPageReturned() {
//        // given
//        Long doctorId = 1L;
//        VisitAvailability visitAvailability = VisitAvailability.FREE;
...
//
//    @Test
//    void getFilteredVisits_FreeVisitFoundBySpecializationAndDate_PageReturned() {
//        // given
...
//        VisitStatus visitStatus = VisitStatus.CURRENT;
//        VisitAvailability visitAvailability = VisitAvailability.FREE;
//        Doctor doctor = createDoctor();
//        Visit visit = createVisit();
//        visit.setDoctor(doctor);
...
//        Pageable pageable = PageRequest.of(0, 1);
//        Page<Visit> page = new PageImpl<>(visits, pageable, 1);
//        when(visitRepository.findByStartDateGreaterThanEqualAndStartDateLessThanAndDoctorSpecializationAndVisitStatusAndPatientIsNull(
//                fromDate.atStartOfDay(), toDate.plusDays(1).atStartOfDay(), Specialization.DERMATOLOGIST, visitStatus, pageable)).thenReturn(page);
//        // when
//        PageDto<VisitDto> result = visitService.getFilteredVisits(fromDate, toDate, doctorSpecialization, visitAvailability, pageable);
//        // then
//        Assertions.assertAll(
//                () -> assertEquals(page.getTotalPages(), result.totalPages()),
//                () -> assertEquals(page.getTotalElements(), result.totalElements()),
//                () -> assertFalse(result.content().isEmpty())
//        );
//        verify(visitRepository, times(1)).findByStartDateGreaterThanEqualAndStartDateLessThanAndDoctorSpecializationAndVisitStatusAndPatientIsNull(
//                fromDate.atStartOfDay(), toDate.plusDays(1).atStartOfDay(), Specialization.DERMATOLOGIST, visitStatus, pageable);
//        verifyNoMoreInteractions(visitRepository);
//        verifyNoInteractions(doctorRepository, patientRepository);
//    }
//
//    @Test
//    void getFilteredVisits_FreeVisitFoundByDate_PageReturned() {
//        // given
//        LocalDate fromDate = LocalDate.of(2027, 1, 1);
//        LocalDate toDate = LocalDate.of(2027, 5, 1);
//        VisitStatus visitStatus = VisitStatus.CURRENT;
...
//        Pageable pageable = PageRequest.of(0, 1);
//        Page<Visit> page = new PageImpl<>(visits, pageable, 1);
//        when(visitRepository.findByStartDateGreaterThanEqualAndStartDateLessThanAndVisitStatusAndPatientIsNull(
//                fromDate.atStartOfDay(), toDate.plusDays(1).atStartOfDay(), visitStatus, pageable)).thenReturn(page);
//        // when
//        PageDto<VisitDto> result = visitService.getFilteredVisits(fromDate, toDate, null, visitAvailability, pageable);
//        // then
//        Assertions.assertAll(
//                () -> assertEquals(page.getTotalPages(), result.totalPages()),
//                () -> assertEquals(page.getTotalElements(), result.totalElements()),
//                () -> assertFalse(result.content().isEmpty())
//        );
//        verify(visitRepository, times(1)).findByStartDateGreaterThanEqualAndStartDateLessThanAndVisitStatusAndPatientIsNull(
//                fromDate.atStartOfDay(), toDate.plusDays(1).atStartOfDay(), visitStatus, pageable);
//        verifyNoMoreInteractions(visitRepository);
//        verifyNoInteractions(doctorRepository, patientRepository);
//    }
//
//    @Test
//    void getFilteredVisits_CanceledVisitFoundBySpecialization_PageReturned() {
//        // given
//        LocalDate fromDate = LocalDate.of(2027, 1, 1);
//        LocalDate toDate = LocalDate.of(2027, 5, 1);
//        VisitAvailability visitAvailability = VisitAvailability.ALL;
//        VisitStatus visitStatus = VisitStatus.CANCELED;
...
//        Pageable pageable = PageRequest.of(0, 1);
//        Page<Visit> page = new PageImpl<>(visits, pageable, 1);
//        when(visitRepository.findByStartDateGreaterThanEqualAndStartDateLessThanAndDoctorSpecialization(
//                fromDate.atStartOfDay(), toDate.plusDays(1).atStartOfDay(), specialization, pageable)).thenReturn(page);
//        // when
//        PageDto<VisitDto> result = visitService.getFilteredVisits(fromDate, toDate, specialization, visitAvailability, pageable);
//        // then
//        Assertions.assertAll(
//                () -> assertEquals(page.getTotalPages(), result.totalPages()),
//                () -> assertEquals(page.getTotalElements(), result.totalElements()),
//                () -> assertFalse(result.content().isEmpty())
//        );
//        verify(visitRepository, times(1)).findByStartDateGreaterThanEqualAndStartDateLessThanAndDoctorSpecialization(
//                fromDate.atStartOfDay(), toDate.plusDays(1).atStartOfDay(), specialization, pageable);
//        verifyNoMoreInteractions(visitRepository);
//        verifyNoInteractions(doctorRepository, patientRepository);
//    }
//
//    @Test
//    void getFilteredVisits_VisitFoundByDate_PageReturned() {
//        // given
//        LocalDate fromDate = LocalDate.of(2027, 1, 1);
//        LocalDate toDate = LocalDate.of(2027, 5, 1);
//        VisitAvailability visitAvailability = VisitAvailability.ALL;
...
//        Pageable pageable = PageRequest.of(0, 1);
//        Page<Visit> page = new PageImpl<>(visits, pageable, 1);
//        when(visitRepository.findByStartDateGreaterThanEqualAndStartDateLessThan(
//                fromDate.atStartOfDay(), toDate.plusDays(1).atStartOfDay(), pageable)).thenReturn(page);
//        // when
//        PageDto<VisitDto> result = visitService.getFilteredVisits(fromDate, toDate, null, visitAvailability, pageable);
//        // then
//        Assertions.assertAll(
...
//                () -> assertFalse(result.content().isEmpty())
//        );
//        verify(visitRepository, times(1)).findByStartDateGreaterThanEqualAndStartDateLessThan(
//                fromDate.atStartOfDay(), toDate.plusDays(1).atStartOfDay(), pageable);
//        verifyNoMoreInteractions(visitRepository);
//        verifyNoInteractions(doctorRepository, patientRepository);
//    }
//
...
//
//        VisitNotFoundException exception = assertThrows(VisitNotFoundException.class, () -> visitService.cancelVisit(visitId));
//
//        Assertions.assertAll(
...
//        when(visitRepository.findById(visitId)).thenReturn(Optional.of(visit));
//
//        VisitAlreadyCanceledException exception = assertThrows(VisitAlreadyCanceledException.class, () -> visitService.cancelVisit(visitId));
//
//        Assertions.assertAll(
