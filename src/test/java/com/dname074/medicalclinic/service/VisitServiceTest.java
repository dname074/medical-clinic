...
public class VisitServiceTest {
    ...
    void getVisitsByDoctorId_FreeVisitFound_PageReturned() {
        ...
        // when
        PageDto<VisitDto> result = visitService.getVisitsByDoctorId(doctorId, status, pageable);
        // then
        Assertions.assertAll(
                () -> assertEquals(page.getTotalPages(), result.totalPages()),
                () -> assertEquals(page.getTotalElements(), result.totalElements()),
    ...
    void getFilteredVisits_FreeVisitFoundBySpecializationAndDate_PageReturned() {
        ...
        // when
        PageDto<VisitDto> result = visitService.getFilteredVisits(fromDate, toDate, doctorSpecialization, status, pageable);
        // then
        Assertions.assertAll(
                () -> assertEquals(page.getTotalPages(), result.totalPages()),
                () -> assertEquals(page.getTotalElements(), result.totalElements()),
    ...
    void getFilteredVisits_FreeVisitFoundByDate_PageReturned() {
        ...
        // when
        PageDto<VisitDto> result = visitService.getFilteredVisits(fromDate, toDate, null, status, pageable);
        // then
        Assertions.assertAll(
                () -> assertEquals(page.getTotalPages(), result.totalPages()),
                () -> assertEquals(page.getTotalElements(), result.totalElements()),
    ...
    void getFilteredVisits_CanceledVisitFoundBySpecialization_PageReturned() {
        ...
        // when
        PageDto<VisitDto> result = visitService.getFilteredVisits(fromDate, toDate, specialization, status, pageable);
        // then
        Assertions.assertAll(
                () -> assertEquals(page.getTotalPages(), result.totalPages()),
                () -> assertEquals(page.getTotalElements(), result.totalElements()),
