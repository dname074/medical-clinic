...
//
//    @Test
//    void getFreeVisitsByDoctorId_DoctorFound_VisitsPageReturned() throws Exception {
//        // given
//        Long doctorId = 1L;
//        int page = 0;
//        int size = 1;
...
//
//    @Test
//    void getVisitsByDateAndDoctorSpecialization_VisitFound_VisitsPageReturned() throws Exception {
//        // given
...
//        Page<VisitDto> visitsPage = new PageImpl<>(visits, pageable, 1);
//        PageDto<VisitDto> visitsPageDto = pageMapper.toVisitDto(visitsPage);
//        when(service.getVisitsByDateAndDoctorSpecialization(date, specialization, pageable)).thenReturn(visitsPageDto);
//        // when & then
...
//                .andExpect(jsonPath("$.pageNumber").value(0))
//                .andExpect(jsonPath("$.pageSize").value(1));
//        verify(service, times(1)).getVisitsByDateAndDoctorSpecialization(date, specialization, pageable);
//        verifyNoMoreInteractions(service);
//    }
//
//    @Test
