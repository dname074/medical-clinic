...
//        when(service.findAllDoctors(any(), any())).thenReturn(doctorsPageDto);
//        // when & then
...
//        verify(service,times(1)).findAllDoctors(pageable, null);
//        verifyNoMoreInteractions(service);
//    }
//
//    @Test
//    void findAllDoctors_DoctorWithSearchedSpecializationFound_PageReturned() throws Exception {
//        // given
...
//                .andExpect(jsonPath("$.pageNumber").value(0))
//                .andExpect(jsonPath("$.pageSize").value(1));
//        verify(service,times(1)).findAllDoctors(pageable, Specialization.DERMATOLOGIST);
//        verifyNoMoreInteractions(service);
//    }
//
//    @Test
