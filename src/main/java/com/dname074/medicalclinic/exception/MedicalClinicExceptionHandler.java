...
public class MedicalClinicExceptionHandler {
    ...
    public ResponseEntity<MedicalClinicExceptionDto> handleMedicalClinicException(MedicalClinicException exception) {
        return ResponseEntity.status(exception.getStatus()).body(new MedicalClinicExceptionDto(exception.getMessage(), exception.getStatus()));
    }
    ...
    public ResponseEntity<MedicalClinicExceptionDto> handleDateTimeParseException(DateTimeParseException exception) {
        ...
        return ResponseEntity.status(status).body(new MedicalClinicExceptionDto(exception.getMessage(), status));
    }
}
